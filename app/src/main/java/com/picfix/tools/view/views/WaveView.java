...
public class WaveView extends View {
    ...
    //背景色
    private static final int OUTER_RING2_COLOR = 0xFFf8f8f8;
    //进度条填充颜色
    private static final int OUTER_RING3_COLOR = 0xFF7ACDFF;
    //线条色
    private static final int OUTER_RING4_COLOR = 0xFFffffff;
    ...
    public static final int[] SWEEP_GRADIENT_COLORS = new int[]{0xFF7ACDFF, 0xFF55A2FF, 0xFF55A2FF};
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        strokeColor4 = array.getColor(R.styleable.WaveProgressView_stroke_color, OUTER_RING4_COLOR);
        ...
        bottomTextColor = array.getColor(R.styleable.WaveProgressView_bottom_textColor, Color.BLACK);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (strokeWidth > 0) {
            ...
            canvas.drawArc(rf1, 130, 280, false, outerRingPaint);
            ...
            if (progress > 0) {
                ...
                canvas.drawArc(rf, 130, (float) (progress * 2.8), false, outerRingPaint3);
            ...
            canvas.drawText(bottomText, width / 2.0f - textRect.width() / 1.5f, bottomTextY, bottomPaint);
