...
import com.piceasy.tools.config.WalletConstant
...
object PaymentsUtil {
     ...
     *
     *
     * TODO: Check with your gateway on the parameters to pass and modify them in WalletConstant.java.
     *
    ...
    private fun gatewayTokenizationSpecification(): JSONObject {
        return JSONObject().apply {
            ...
            put("parameters", JSONObject(WalletConstant.PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS))
        }
    }
    ...
    private fun directTokenizationSpecification(): JSONObject {
        if (WalletConstant.DIRECT_TOKENIZATION_PUBLIC_KEY == "REPLACE_ME" ||
            (WalletConstant.DIRECT_TOKENIZATION_PARAMETERS.isEmpty() ||
                    WalletConstant.DIRECT_TOKENIZATION_PUBLIC_KEY.isEmpty())
        ) {

            throw RuntimeException(
                "Please edit the WalletConstant.java file to add protocol version & public key."
            )
        }

        return JSONObject().apply {
            put("type", "DIRECT")
            put("parameters", JSONObject(WalletConstant.DIRECT_TOKENIZATION_PARAMETERS))
        }
    }
     ...
     *
     *
     * TODO: Confirm card networks supported by your app and gateway & update in WalletConstant.java.
     *
     * @return Allowed card networks
     * @see [CardParameters](https://developers.google.com/pay/api/android/reference/object.CardParameters)
     */
    private val allowedCardNetworks = JSONArray(WalletConstant.SUPPORTED_NETWORKS)
     ...
     * and make updates in WalletConstant.java.
     *
     * @return Allowed card authentication methods.
     * @see [CardParameters](https://developers.google.com/pay/api/android/reference/object.CardParameters)
     */
    private val allowedCardAuthMethods = JSONArray(WalletConstant.SUPPORTED_METHODS)
     ...
     * environment and theme set in [WalletConstant].
     *
     * @param activity is the caller's activity.
     */
    fun createPaymentsClient(activity: Activity): PaymentsClient {
        val walletOptions = Wallet.WalletOptions.Builder()
            .setEnvironment(WalletConstant.PAYMENTS_ENVIRONMENT)
            .build()
    ...
    private fun getTransactionInfo(price: String): JSONObject {
        return JSONObject().apply {
            ...
            put("countryCode", WalletConstant.COUNTRY_CODE)
            put("currencyCode", WalletConstant.CURRENCY_CODE)
        }
    }
