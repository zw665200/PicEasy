...
interface BaseService {
    ...
    @POST("getSubs")
    @FormUrlEncoded
    fun getSubServiceList(@Field("clientToken") clientToken: String): Observable<Response<Menu>>

    @POST("grantAKToken")
    @FormUrlEncoded
    fun getOssToken(@Field("clientToken") clientToken: String): Observable<Response<OssParam>>

    @POST("third/wechatGrantLogin")
    @FormUrlEncoded
    fun getUserByWechat(
    ...
    fun getGoogleToken(@Body getToken: GetToken): Observable<Response<Token>>
