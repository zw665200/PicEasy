...
public class CropCanvas extends AppCompatImageView {
    ...
    public void imageScale() {
        ...
        ChooseArea = new RectF(dst.left + 100, dst.top + 100, dst.right / 4, dst.bottom / 4);
        this.setPressRecLoc();
        this.invalidate();
    }
...
//        set_LeftArea_Alpha();
    ...
    private void setPressRecLoc() {
        recLT.set(ChooseArea.left - 30, ChooseArea.top - 30, ChooseArea.left + 30, ChooseArea.top + 30);
        recLB.set(ChooseArea.left - 30, ChooseArea.bottom - 30, ChooseArea.left + 30, ChooseArea.bottom + 30);
        recRT.set(ChooseArea.right - 30, ChooseArea.top - 30, ChooseArea.right + 30, ChooseArea.top + 30);
        recRB.set(ChooseArea.right - 30, ChooseArea.bottom - 30, ChooseArea.right + 30, ChooseArea.bottom + 30);
    }
...
//        canvas.drawCircle(recLT.left, recLT.top, 40, mPaint);
