...
import com.piceasy.tools.view.base.BaseFragmentActivity
import com.piceasy.tools.view.fragment.FHome
import com.piceasy.tools.view.fragment.FMine
import com.piceasy.tools.view.fragment.FTools
...
class MainActivity : BaseFragmentActivity(), View.OnClickListener {
    ...
    companion object {
        ...
        private var BOTTOM_TEXT_ARRAY = arrayOf("Home", "Tools", "Me")
        private const val BOTTOM_CHECKED_COLOR: Int = 0xff6BB4FF.toInt()
        private const val BOTTOM_UNCHECKED_COLOR: Int = 0xff212121.toInt()

        private val FRAGMENT_CLASS_ARRAY: Array<Class<out BaseFragment>> = arrayOf(
            FHome::class.java,
            FTools::class.java,
            FMine::class.java
        )
