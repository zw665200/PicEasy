...
import com.piceasy.tools.view.views.ScaleInTransformer
...
open class FTools : BaseFragment() {
    ...
    private fun initMainRecycleView() {
        val mainPics = mutableListOf<Resource>()
        mainPics.add(Resource("contrast", R.drawable.tools_enhance,getString(R.string.title_contrast) ))
        mainPics.add(Resource("style_trans", R.drawable.tools_style_shift,getString(R.string.title_trans_style)))
        mainPics.add(Resource("morph", R.drawable.tools_portrait, getString(R.string.title_morph)))
        mainPics.add(Resource("age_trans", R.drawable.tools_age_conversion, getString(R.string.title_age_trans)))
        mainPics.add(Resource("defogging", R.drawable.tools_defogging,getString(R.string.title_defogging)))
        mainPics.add(Resource("gender_trans", R.drawable.tools_gender_transtion,getString(R.string.title_gender_trans)))
        mainPics.add(Resource("resize", R.drawable.tools_amplification, getString(R.string.title_resize)))
        mainPics.add(Resource("stretch", R.drawable.tools_repair,getString(R.string.title_stretch_fix) ))
        mainPics.add(Resource("comming_soon", R.drawable.tools_coming_soon, getString(R.string.title_comming_soon)))
