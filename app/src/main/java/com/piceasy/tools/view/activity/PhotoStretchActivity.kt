...
class PhotoStretchActivity : BaseActivity() {
    ...
    override fun initData() {
        ...
        LogReportManager.logReport("图片拉伸恢复", "访问页面", LogReportManager.LogType.OPERATION)
    ...
    private fun choosePic(index: Int) {
        when (index) {
            0 -> {
                ...
                bigPic.setImageResource(R.drawable.iv_strech_after_1)
                bigPicBefore.setImageResource(R.drawable.iv_strech_before_1)
            }
            1 -> {
                ...
                bigPic.setImageResource(R.drawable.iv_strech_after_2)
                bigPicBefore.setImageResource(R.drawable.iv_strech_before_2)
            }
        }
    }
    ...
    private fun chooseAlbum() {
        ...
        LogReportManager.logReport("图片拉伸恢复", "打开相册", LogReportManager.LogType.OPERATION)
    ...
    private fun firebaseAnalytics(key: String, value: String) {
        ...
        Firebase.analytics.logEvent("page_stretch_recovery", bundle)
